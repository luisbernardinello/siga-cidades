...
Widget placeCard(Place place, bool isDesktop) {
  ...
  return Card(
    ...
    child: Column(
      mainAxisSize:
          MainAxisSize.min, // Reduz o tamanho da coluna para evitar overflow
      ...
      children: [
        ...
        Padding(
          ...
          child: FittedBox(
            fit: BoxFit.scaleDown, // Diminui o texto para caber no espaço
            child: Text(
              place.name,
        ...
        ClipRRect(
          ...
          child: AspectRatio(
            aspectRatio: 16 / 9, // Define a proporção para ser responsivo
            child: Image.network(
              place.imageUrl,
